...
<body>
  ...
  <div class="container my-4 my-5">
    <div class="row featurette d-flex justify-contect-center align-items-center">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">This is Krishna Sales & Service Detail's.
          <span class="text-muted">Krishna Sales & Service</span>
        </h2>
        <p class="lead">Krishna Sales & Service Best Service of Water Filters, Gas Geyser & Gharghanti.</p>
      </div>
      <div class="col-md-5">
      <div class="inner">
        <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
          height="500" src="img/about/kss2.png" alt="" srcset="">
      </div>
      </div>
    </div>
    ...
    <div class="row featurette d-flex justify-contect-center align-items-center">
      <div class="col-md-7 order-md-2">
        ...
        <p class="lead">Krishna Sales & Service Chela has an experience of 20 year's.</p>
      </div>
    ...
    <div class="row featurette d-flex justify-contect-center align-items-center">
      <div class="col-md-7">
        <h2 class="featurette-heading fw-normal lh-1">This is Jagruti Company Detail's.<br>
          <span class="text-muted">Jagruti Company</span>
        </h2>
        <p class="lead">The Makers of India’s No.1 Atta Chakki.</p>
      </div>
      <div class="col-md-5">
      <div class="inner">
        <img class="bd-placeholder-img bd-placeholder-img-lg featurette-image img-fluid mx-auto" width="500"
          height="500" src="img/about/jagruti1.jpg" alt="" srcset="">
      </div>
      </div>
    </div>
  </div>
