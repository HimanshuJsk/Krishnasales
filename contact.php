<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if(mysqli_num_rows($result) > 0) {
            ...
            // You can also redirect the user back to the form or do any other action
        } else {
            // Proceed with the insertion as the email is unique
            $sql="INSERT INTO `contact` (email,mobileno,checkboxdata,complaint) 
                  VALUES('$email','$mobileno','$alldata','$complaint')";
...
<body>
	...
	<div class="container">
		<form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post" name="contactform"
			...
			<br>
			E-mail:
			<input type="email" placeholder="E-mail" name="email" value="<?php if(isset($_POST['email'])) echo htmlspecialchars($_POST['email']); ?>">
			<br><br>
			Mobile No:
			<input type="number" placeholder="Mobile No" name="mobileno" value="<?php if(isset($_POST['mobileno'])) echo htmlspecialchars($_POST['mobileno']); ?>">
			<br><br>
			<input type="checkbox" name="data[]" value="Waterfilter" >Water filter<br>
			<input type="checkbox" name="data[]" value="Gasgeyser" >Gas geyser<br>
			<input type="checkbox" name="data[]" value="Gharghanti" >Gharghanti
			<br><br>
			Enter Your Complaint:
			<textarea type="text" placeholder="Complaint" name="complaint" value="<?php if(isset($_POST['complaint'])) echo htmlspecialchars($_POST['complaint']); ?>"></textarea>
			<br><br>
	...
	<footer>
		<p style="color:white; text-align: center; background-color: rgb(66, 66, 66); padding: 15px 0;">&copy;
			Copyright
