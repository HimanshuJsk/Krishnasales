...
<body>
    ...
    <div class="container">
        <div class="flex-container" style="justify-content: center;">
            <div>
                <center><img src="img/certificate/iso.png" width="225px;" height="190px;" style="border-radius: 5px;">
                </center>
            </div>
            <div>
                <center><img src="img/certificate/td.png" width="225px;" height="190px;" style="border-radius: 5px;""></center>
            </div>
            <div>
                <center><img src=" img/certificate/cum.png" width="225px;" height="190px;" style="border-radius: 5px;">
                </center>
            </div>
            <div>
                <center><img src="img/certificate/kc1.jpg" width="230px;" height="180px;"
                        style="border-radius: 5px; margin-left: 10px;"></center>
            </div>
        </div>
    </div>
    <!--start footer-->
